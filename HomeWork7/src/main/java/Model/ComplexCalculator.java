package Model;
 //Класс для работы с калькулятором, позволяющий работать с комплексными значениями.
 //Класс реализует методы для работы с числами, такие как сумма, вычитание, умножение и деление.
